...
class Service1View(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        logging.log(msg=serializer.data, level=logging.INFO)

        df_data, config = to_df(serializer.data)
        dict_data_interpolated = interpolation(df_data, config)
